...
namespace O24OpenAPI.WFO.Mapping;
...
public class MappingConfiguration : IMappingConfigurator
{
    public void Configure(IMapperConfigurationBuilder builder)
    {
        builder
            ...
            .ForMember(d => d.response_content, o => o.MapFrom(s => s.response_content.ToJson(null, null)));

        builder.CreateMap<WorkflowStepInfoModel, WorkflowStepInfo>()
            .ForMember(d => d.sending_condition, o => o.MapFrom(s => s.sending_condition.ToJson(null, null)))
