...
public class WorkflowStepInfoModel : BaseO24OpenAPIModel
{
    ...
    public WorkflowStepInfoModel(WFScheme wfScheme)
    {
        ...
        p1_status = WorkflowExecutionStatus.Created;
        p1_request = wfScheme;
        p2_status = WorkflowExecutionStatus.NotProcessed;
    }
    ...
    public WorkflowExecutionStatus p1_status { get; set; }
    ...
    public WorkflowExecutionStatus p2_status { get; set; }
