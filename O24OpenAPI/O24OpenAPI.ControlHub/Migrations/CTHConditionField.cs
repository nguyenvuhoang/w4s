...
public class CTHConditionField
{
    ...
    public static readonly List<string> UserPasswordCondition =
    [
        nameof(UserPassword.UserId)
    ];
    ...
    public static readonly List<string> UserLevelCondition =
    [
      nameof(UserLevel.LevelCode)
    ];
