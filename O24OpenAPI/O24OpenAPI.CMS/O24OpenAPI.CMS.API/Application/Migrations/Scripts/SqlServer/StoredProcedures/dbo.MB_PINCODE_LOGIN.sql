USE O24CMS
GO
IF OBJECT_ID('dbo.MB_PINCODE_LOGIN', 'P ') IS NOT NULL DROP PROCEDURE dbo.MB_PINCODE_LOGIN;
GO
CREATE PROCEDURE [dbo].[MB_PINCODE_LOGIN]
...
BEGIN TRY
    ...
    DECLARE @PassWord varchar(500) = JSON_VALUE(@WorkflowScheme, @PathData + '.Pincode');
