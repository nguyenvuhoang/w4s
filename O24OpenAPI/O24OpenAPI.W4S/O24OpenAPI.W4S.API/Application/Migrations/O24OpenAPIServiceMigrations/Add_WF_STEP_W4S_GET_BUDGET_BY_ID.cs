...
[O24OpenAPIMigration(
    "2026/11/01 21:25:25:0000000",
    "Add_WF_STEP_W4S_GET_BUDGET_BY_ID",
    MigrationProcessType.Update
)]
[Environment(EnvironmentType.All)]
public class Add_WF_STEP_W4S_GET_BUDGET_BY_ID : BaseMigration
{
    public override void Up()
    {
        var step = new O24OpenAPIService
        {
            StepCode = WorkflowStepCode.W4S.WF_STEP_W4S_GET_BUDGET_BY_ID,
