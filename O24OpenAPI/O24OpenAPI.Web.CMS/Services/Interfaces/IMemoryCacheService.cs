...
public interface IMemoryCacheService
{
    ...
    Task<T> GetOrCreateAsync<T>(string cacheKey, Func<Task<T>> factory,
        TimeSpan absoluteExpirationRelativeToNow = default, TimeSpan slidingExpiration = default);
    ...
    /// <returns>The</returns>
    T GetOrCreate<T>(string cacheKey, Func<T> factory, TimeSpan absoluteExpirationRelativeToNow = default,
