...
public class D_TEMPLATETRANSFERWorkflowService : BaseQueueService
{
    /// <summary>
    /// The id bankservice
    /// </summary>
    private readonly ID_TEMPLATETRANSFERService _dBank = EngineContext.Current.Resolve<ID_TEMPLATETRANSFERService>();
    /// <summary>
