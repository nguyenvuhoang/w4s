...
public class SavingProductWorkflowService : BaseQueueService
{
    ...
    /// The id bankservice
    /// </summary>
    private readonly ISavingProductService _savingProductService = EngineContext.Current.Resolve<ISavingProductService>();
    /// <summary>
    ...
    public async Task<WorkflowScheme> Insert(WorkflowScheme workflow)
    {
        ...
        return await Invoke<SavingProductInsertModel>(workflow, async () =>
        {
    ...
    public async Task<WorkflowScheme> Update(WorkflowScheme workflow)
    {
        ...
        return await Invoke<SavingProductUpdateModel>(workflow, async () =>
        {
            ...
            entity.ProductName = model.ProductName != null ? JsonConvert.SerializeObject(model.ProductName) : JsonConvert.SerializeObject(entity.ProductName);
            entity.Description = model.Description != null ? JsonConvert.SerializeObject(model.Description) : JsonConvert.SerializeObject(entity.Description);
    ...
    public async Task<WorkflowScheme> SearchSimple(WorkflowScheme workflow)
    {
        ...
        return await Invoke<SimpleSearchModel>(workflow, async () =>
        {
            ...
            var items = result.ToPagedListModel<SavingProductSimpleSearchResponseModel, SavingProductSimpleSearchResponseModel>();
            return items;
        });
    }
    /// <summary>
    ...
    public async Task<WorkflowScheme> SearchAdvance(WorkflowScheme workflow)
    {
        ...
        return await Invoke<SavingProductAdvancedSearchRequestModel>(workflow, async () =>
        {
            var result = await _savingProductService.AdvancedSearch(model);
            var items = result.ToPagedListModel<SavingProductAdvancedSearchResponseModel, SavingProductAdvancedSearchResponseModel>();
            return items;
        });
    }
}
