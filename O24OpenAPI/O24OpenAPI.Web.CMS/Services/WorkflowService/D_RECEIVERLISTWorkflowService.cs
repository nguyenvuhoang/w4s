...
public class D_RECEIVERLISTWorkflowService : BaseQueueService
{
    /// <summary>
    /// The id bankservice
    /// </summary>
    private readonly ID_RECEIVERLISTService _dBank =
        EngineContext.Current.Resolve<ID_RECEIVERLISTService>();
