...
namespace O24OpenAPI.CTH.API.Application.Features.User
{
    ...
    public class VerifyPasswordHandler(IUserPasswordRepository userPasswordRepository) : ICommandHandler<VerifyPasswordCommnad, bool>
    {
        public async Task<bool> HandleAsync(VerifyPasswordCommnad request, CancellationToken cancellationToken = default)
        {
