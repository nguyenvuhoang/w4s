...
public class ChangeDeviceAsyncCommand : BaseTransactionModel, ICommand<AuthResponseModel>
{
...
[CqrsHandler]
public class ChangeDeviceAsyncHandle(
...
) : ICommandHandler<ChangeDeviceAsyncCommand, AuthResponseModel>
{
    public async Task<AuthResponseModel> HandleAsync(
        ChangeDeviceAsyncCommand request,
