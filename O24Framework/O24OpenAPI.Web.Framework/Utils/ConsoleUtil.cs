...
public static class ConsoleUtil
{
    ...
    private sealed class ConsoleMessage
    {
        ...
        /// <returns>The <see cref="ConsoleMessage"/></returns>
        public static ConsoleMessage TemplateMessage(LogLevel level, string template, params (string key, object? value)[] properties)
            => new()
            {
                Kind = MessageKind.Simple,
                Level = level,
        ...
        /// <returns>The <see cref="ConsoleMessage"/></returns>
        public static ConsoleMessage Table(string title, LogLevel level, IReadOnlyList<string> headers, IReadOnlyList<IReadOnlyList<string>> rows)
            => new()
            {
        ...
        /// </summary>
        /// <returns>The <see cref="ConsoleMessage"/></returns>
        public static ConsoleMessage GroupEnd()
            => new()
            {
                Kind = MessageKind.GroupEnd
            };
    }
    ...
    /// <param name="template">The template<see cref="string"/></param>
    /// <param name="properties">The properties<see cref="(string key, object? value)[]"/></param>
    public static void WriteInfo(string template, params (string key, object? value)[] properties)
    ...
    /// <param name="template">The template<see cref="string"/></param>
    /// <param name="properties">The properties<see cref="(string key, object? value)[]"/></param>
    public static void WriteError(string template, params (string key, object? value)[] properties)
    ...
    /// <param name="template">The template<see cref="string"/></param>
    /// <param name="properties">The properties<see cref="(string key, object? value)[]"/></param>
    public static void WriteSuccess(string template, params (string key, object? value)[] properties)
    ...
    /// <param name="template">The template<see cref="string"/></param>
    /// <param name="properties">The properties<see cref="(string key, object? value)[]"/></param>
    public static void WriteDebug(string template, params (string key, object? value)[] properties)
    ...
    /// <param name="template">The template<see cref="string"/></param>
    /// <param name="properties">The properties<see cref="(string key, object? value)[]"/></param>
    public static void WriteWarning(string template, params (string key, object? value)[] properties)
    ...
    private static void RenderFramedSimpleMessage(ConsoleMessage msg)
    {
        ...
        var text = msg.Text ?? RenderTemplate(msg.Template!, msg.Properties ?? Array.Empty<(string, object?)>());
    ...
    private static void RenderGroupFooter(GroupContext ctx)
    {
        ...
        Console.WriteLine($"*  Messages: {ctx.MessageCount}, Duration: {duration.TotalMilliseconds:N0} ms");
        Console.WriteLine(border);
        Console.WriteLine();
    ...
    private static IEnumerable<string> BuildTableLines(IReadOnlyList<string> headers, IReadOnlyList<IReadOnlyList<string>> rows)
    {
